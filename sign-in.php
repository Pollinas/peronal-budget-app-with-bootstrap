...
<body>
    ...
    <div class="container-fluid main d-flex flex-column p-4 align-self-center align-items-center justify-content-center my-5  ">
        ...
        <form method="post" action="check-login.php"  class="fw-bold ">
            ...
            <hr>
            <div class="d-flex align-self-center p-3 fw-bold align-items-center justify-content-center"><span>lub zaloguj się używając hasła</span></div>


            <div class="input-group d-flex align-self-center m-3 px-5">
            ...
            <div class="input-group d-flex m-3 px-5 align-self-center">
            ...
            <div class=" d-flex justify-content-center">
                <button type="submit" class="btn m-3 p-3" id="register">ZALOGUJ SIĘ</button>
            </div>
